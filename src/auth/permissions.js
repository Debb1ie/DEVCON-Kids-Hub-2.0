...
export const ROUTE_SCOPES = Object.freeze({
  ...
  '/dashboard/social-media': { super_admin: 'nationwide', admin: 'nationwide', chapter_coordinator: 'own_chapter', event_coordinator: 'assigned_event' },
  ...
  '/dashboard/knowledge-base': { super_admin: 'nationwide', admin: 'nationwide', chapter_coordinator: 'own_chapter', event_coordinator: 'assigned_event', volunteer: 'own' },
...
export const ACTION_SCOPES = Object.freeze({
  ...
  'knowledge.manage': { super_admin: 'platform', admin: 'nationwide' },
  'faq.manage': { super_admin: 'platform', admin: 'nationwide' },
  'social.manage': { super_admin: 'nationwide', admin: 'nationwide', chapter_coordinator: 'own_chapter', event_coordinator: 'assigned_event' },
